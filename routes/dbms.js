...
var database = "voc27_db";  //database name
var user = "cs341-01";         //username (change to match your db)
var password = "aSJRFL8C(zQlQfcG";  //password (change to match your db, yes THIS IS VERY POOR PRACTICE)
